...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[trackable__object__graph__pb2.DESCRIPTOR,struct__pb2.DESCRIPTOR,tensor__shape__pb2.DESCRIPTOR,types__pb2.DESCRIPTOR,versions__pb2.DESCRIPTOR,variable__pb2.DESCRIPTOR,])
...
_SAVEDOBJECT.fields_by_name['children'].message_type = trackable__object__graph__pb2._TRACKABLEOBJECTGRAPH_TRACKABLEOBJECT_OBJECTREFERENCE
_SAVEDOBJECT.fields_by_name['slot_variables'].message_type = trackable__object__graph__pb2._TRACKABLEOBJECTGRAPH_TRACKABLEOBJECT_SLOTVARIABLEREFERENCE
...
_SAVEDUSEROBJECT.fields_by_name['version'].message_type = versions__pb2._VERSIONDEF
_SAVEDFUNCTION.fields_by_name['function_spec'].message_type = _FUNCTIONSPEC
_SAVEDCONCRETEFUNCTION.fields_by_name['canonicalized_input_signature'].message_type = struct__pb2._STRUCTUREDVALUE
_SAVEDCONCRETEFUNCTION.fields_by_name['output_signature'].message_type = struct__pb2._STRUCTUREDVALUE
_SAVEDVARIABLE.fields_by_name['dtype'].enum_type = types__pb2._DATATYPE
_SAVEDVARIABLE.fields_by_name['shape'].message_type = tensor__shape__pb2._TENSORSHAPEPROTO
_SAVEDVARIABLE.fields_by_name['synchronization'].enum_type = variable__pb2._VARIABLESYNCHRONIZATION
_SAVEDVARIABLE.fields_by_name['aggregation'].enum_type = variable__pb2._VARIABLEAGGREGATION
_FUNCTIONSPEC.fields_by_name['fullargspec'].message_type = struct__pb2._STRUCTUREDVALUE
_FUNCTIONSPEC.fields_by_name['input_signature'].message_type = struct__pb2._STRUCTUREDVALUE
