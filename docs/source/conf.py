...
if rtd_version not in ["stable", "latest", "mrgn-docs", 'wg-docs']:
    rtd_version = "stable"
...
htmlhelp_basename = 'KioskRedisConsumerdoc'
...
latex_documents = [
    (master_doc, 'KioskRedisConsumer.tex', 'Kiosk Redis Consumer Documentation',
...
man_pages = [
    (master_doc, 'kioskredisconsumer', 'Kiosk Redis Consumer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'KioskRedisConsumer', 'Kiosk Redis Consumer Documentation',
     author, 'KioskRedisConsumer', 'One line description of project.',
     'Miscellaneous'),
]
